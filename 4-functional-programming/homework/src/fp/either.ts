 ...
 */
export const map = <E, A, B>(fn: (a: A) => B) => (fa: Either<E, A>): Either<E, B> =>  fa._tag === 'Left' ? fa : right(fn(fa.right));
 ...
 */
export const fromPromise = <E, A>(promise: Promise<A>): Promise<Either<E, A>> => promise.then((a: A) => right(a)).catch((e: E) => left(e));
/**
